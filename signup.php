...
//     <!-- If there are any errros print error -->
if($errors){
...
// Send the user an email with a link to activate.php with their email and avtivation code
$message = "Please click on this link to activate your account:\n\n";
$message .= "http://localhost/25.%20online%20notes%20app/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'laliteshsoni136@gmail.com')){
